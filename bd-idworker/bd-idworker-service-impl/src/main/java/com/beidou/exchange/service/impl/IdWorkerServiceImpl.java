...
public class IdWorkerServiceImpl implements IdWorkerService {
     ...
     */
    public IdWorkerServiceImpl(@Value("${worker.workerId}") long workerId, @Value("${worker.datacenterId}") long datacenterId) {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 1000; i++) {
            IdWorkerServiceImpl idWorker = new IdWorkerServiceImpl(0, 0);
